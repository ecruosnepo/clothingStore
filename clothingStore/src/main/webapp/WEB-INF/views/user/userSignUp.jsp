...
<script type="text/javascript">     
	function pwCheckFunction(){ 
	    ...
	    var pattern2 = /[a-zA-Z]/;
	    var pattern3 = /[~!@#$%^&*()_+|<>?:{}]/;
	    if(userPW1.length < 8 || !pattern1.test(userPW1) || !pattern2.test(userPW1) || !pattern3.test(userPW1)) $('#pwCheckMessage').html('비밀번호는 8자리 이상 문자, 숫자, 특수문자로 구성하여야 합니다.').css('color', 'red').css('font-size', '16px');
